...
public issue requesting a private contact channel without disclosing sensitive details.
...
Helix CLI is a local code generator. It makes no network requests, executes no generated project,
...
The `.helix/project.json` manifest is untrusted: reads are size-bounded, paths must be relative POSIX
